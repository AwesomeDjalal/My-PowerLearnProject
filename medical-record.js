...
////// console.log(g("what is this"+sessionStorage.getItem("appointments"));
...
//// console.log(g("Request Body is   "+defaultOptions);
 ////// console.log(g(defaultOptions) ;
...
.then(response =>{ 
  ...
  //// console.log(g("Resonse returned from server is "+data)
  ...
  alert("Test Result Update Failed, Please Try Again")
  //// console.log(g("Error Message from sever " +error)
})
}
